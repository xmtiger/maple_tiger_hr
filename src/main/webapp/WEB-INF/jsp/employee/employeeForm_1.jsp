...
<html lang="en">
    ...
    <body>
        ...
        <form name="employeeForm" class="well form-horizontal"   id="employee_form" ng-controller="EmployeeFormController" novalidate>
            <fieldset>
                ...
                <uib-tabset active="active">
                    ...
                    <uib-tab index="0" heading="Form Tab">
                        <!-- Text input-->
                        <div class="form-group" ng-class="{ 'has-error' : employeeForm.name.$invalid && !employeeForm.name.$pristine }">
                            <label class="col-md-4 control-label">Name</label>  
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input  name="name" placeholder="Name" class="form-control"  type="text" id="employee_name" ng-model="formData.name" ng-change="nameChange()" ng-minlength="3" ng-maxlength="8"/>
                                    <p ng-show="employeeForm.name.$invalid && !employeeForm.name.$pristine" class="help-block">the name is required.</p>
                                    <p ng-show="employeeForm.name.$error.minlength" class="help-block">The name is too short.</p>
                                    <p ng-show="employeeForm.name.$error.maxlength" class="help-block">The name is too long.</p>
                                </div>
                            </div>
                        </div>
